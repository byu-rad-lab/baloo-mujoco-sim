...
def run_single_trial(perturbation_magnitude, render_mode=None,
    ...
    pid_config = {'kp': 105.123335, 'ki': 12.854383, 'kd': 4.886744,
                  'threshold': 0.092517, 'correction_max': 146.609327} #original gains kp: 80 ki: 2.0 kd : 1.5 threshold: .01 correction max: 70
